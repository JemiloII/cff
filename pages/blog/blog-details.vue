            ...
            <div class="blog-details">
              ...
              <div class="article-content">
                ...
                <ul class="category">
                  ...
                  <li>
                    <nuxt-link to="/">Sell</nuxt-link>
                  </li>
                  <li>
                    <nuxt-link to="/">Tips</nuxt-link>
                  </li>
                  <li>
                    <nuxt-link to="/">Design</nuxt-link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-12">
            <aside class="widget-area" id="secondary">
              <section class="widget widget_comero_posts_thumb">
                ...
                <article class="item">
                  <nuxt-link to="/blog/blog-details" class="thumb">
                    <span class="fullimage cover bg1" role="img"></span>
                  </nuxt-link>
                  <div class="info">
                    <time datetime="2019-06-30">June 30, 2019</time>
                    <h4 class="title usmall">
                      <nuxt-link to="/blog/blog-details">How to change yourself for the better.</nuxt-link>
                    </h4>
                  </div>
                ...
                <article class="item">
                  ...
                  <div class="info">
                    ...
                    <h4 class="title usmall">
                      <nuxt-link to="/blog/blog-details">
                        Google web ranking changing much.
                      </nuxt-link>
                    </h4>
                  </div>
