      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="newsletter-content">
            ...
            <p>Stay up to date with the latest conventions and foam forge news!</p>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <form class="newsletter-form" v-on:submit.prevent>
            <input type="email" class="form-control" placeholder="Enter your email address" id="email"
                   v-model="subscriptions.email" autocomplete="off">
    ...
    methods: {
      subscribe() {
        if (this.subscriptions.email !== '' && this.validateEmail(this.subscriptions.email)) {
          ...
          this.$toast.error(`Please fill in a valid email`, {
            icon: 'fas fa-times'
          });
        }
      },
